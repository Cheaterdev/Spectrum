...
#undef DOMAIN
		...
		struct RootSignatureDesc
		{
			...
			{
				set_sampler((int)samplers_map.size(), space, visibility, desc);
			}
		...
		public:
			...
			RootSignature(const RootSignatureDesc& desc, D3D12_ROOT_SIGNATURE_FLAGS flags = D3D12_ROOT_SIGNATURE_FLAGS::D3D12_ROOT_SIGNATURE_FLAG_CBV_SRV_UAV_HEAP_DIRECTLY_INDEXED);
