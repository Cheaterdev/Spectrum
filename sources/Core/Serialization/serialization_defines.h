...
#define SAVE_PARENT(type)  NP("parent_" SER_STR(type), cereal::base_class<type>(this))
#define SAVE_VPARENT(type)  NP("parent_" SER_STR(type), cereal::virtual_base_class<type>(this))
