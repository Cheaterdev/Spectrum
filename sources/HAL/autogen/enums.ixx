...
export
{
	...
	enum class PSO: int
	{
		...
		VSMBlockerClassifyInitDispatch,
		VSMBlockerClassify,
		VSMSearchVerdictInitDispatch,
		VSMApplyCompute,
	...
	enum class SlotID: unsigned int
	{
		...
		VSMBlockerClassifyInitDispatch = "VSMBlockerClassifyInitDispatch"_crc32,
		VSMSearchVerdictAppend = "VSMSearchVerdictAppend"_crc32,
		VSMSearchVerdictInitDispatch = "VSMSearchVerdictInitDispatch"_crc32,
