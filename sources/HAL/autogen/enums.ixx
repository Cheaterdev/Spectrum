...
export
{
	...
	enum class SlotID: unsigned int
	{
		...
		BloomTemporal = "BloomTemporal"_crc32,
		BloomCopy = "BloomCopy"_crc32,
		BlueNoise = "BlueNoise"_crc32,
		BRDF = "BRDF"_crc32,
		DDGIInfo = "DDGIInfo"_crc32,
		DDGIProbeMetadata = "DDGIProbeMetadata"_crc32,
		DDGIProbes = "DDGIProbes"_crc32,
		DDGISelectors = "DDGISelectors"_crc32,
		DDGIProbeSelectData = "DDGIProbeSelectData"_crc32,
		DDGIProbeTraceData = "DDGIProbeTraceData"_crc32,
		DDGIProbeConvolveData = "DDGIProbeConvolveData"_crc32,
		DDGIProbeResidencyMarkData = "DDGIProbeResidencyMarkData"_crc32,
		DDGIDebugData = "DDGIDebugData"_crc32,
		DDGIIndirectDebugData = "DDGIIndirectDebugData"_crc32,
		DebugLineSegment = "DebugLineSegment"_crc32,
		DebugLines = "DebugLines"_crc32,
		DebugViewGather = "DebugViewGather"_crc32,
		DebugViewDraw = "DebugViewDraw"_crc32,
		...
		GlyphQuad = "GlyphQuad"_crc32,
		GlyphRender = "GlyphRender"_crc32,
		...
		MeshletCaptureWrite = "MeshletCaptureWrite"_crc32,
		...
		VoxelGISelectors = "VoxelGISelectors"_crc32,
