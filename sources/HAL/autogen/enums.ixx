...
export
{
	...
	enum class PSO: int
	{
		...
		ReflectionCombine,
		VSMCopyLevelHiZBatch,
		VSMDownsampleLevelHiZBatch,
		VSMCopyPageDepth,
	...
	enum class SlotID: unsigned int
	{
		...
		VSMDirtyPageInfo = "VSMDirtyPageInfo"_crc32,
		VSMCopyLevelHiZBatch = "VSMCopyLevelHiZBatch"_crc32,
		VSMDownsampleLevelHiZBatch = "VSMDownsampleLevelHiZBatch"_crc32,
