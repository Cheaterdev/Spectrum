...
// ============================================================================
export module HAL:Autogen.PSO.Shadows.PSSM.PSSMApplyCompute;
...
export namespace PSOS
{
	namespace Shadows
	{
		namespace PSSM
		{
			struct PSSMApplyCompute: public PSOBase
			{
				struct Keys {
					GEN_DEF_COMP(Keys);
				private:
				...
				GEN_COMPUTE_PSO(PSSMApplyCompute)
				...
				SimplePSO init_pso(Keys & key, std::function<void(SimplePSO&, Keys&)> f)
				{
					...
					SimplePSO mpso("PSSMApplyCompute");
					if(f) f(mpso,key);
