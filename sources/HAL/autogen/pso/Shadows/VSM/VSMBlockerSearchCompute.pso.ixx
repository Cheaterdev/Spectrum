...
// ============================================================================
export module HAL:Autogen.PSO.Shadows.VSM.VSMBlockerSearchCompute;
...
export namespace PSOS
{
	namespace Shadows
	{
		namespace VSM
		{
			struct VSMBlockerSearchCompute: public PSOBase
			{
				struct Keys {
					GEN_DEF_COMP(Keys);
				private:
				...
				GEN_COMPUTE_PSO(VSMBlockerSearchCompute)
				...
				SimplePSO init_pso(Keys & key, std::function<void(SimplePSO&, Keys&)> f)
				{
					...
					SimplePSO mpso("VSMBlockerSearchCompute");
					if(f) f(mpso,key);
