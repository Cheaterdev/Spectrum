...
// ============================================================================
export module HAL:Autogen.PSO.Shadows.VSM.VSMDownsampleHiZBatch;
...
export namespace PSOS
{
	namespace Shadows
	{
		namespace VSM
		{
			struct VSMDownsampleHiZBatch: public PSOBase
			{
				struct Keys {
					GEN_DEF_COMP(Keys);
				private:
				...
				GEN_COMPUTE_PSO(VSMDownsampleHiZBatch)
				...
				SimplePSO init_pso(Keys & key, std::function<void(SimplePSO&, Keys&)> f)
				{
					...
					SimplePSO mpso("VSMDownsampleHiZBatch");
					if(f) f(mpso,key);
