...
// ============================================================================
export module HAL:Autogen.PSO.VSMCopyLevelHiZBatch;
...
{
	struct VSMCopyLevelHiZBatch: public PSOBase
	{
		struct Keys {
			GEN_DEF_COMP(Keys);
		private:
		...
		GEN_COMPUTE_PSO(VSMCopyLevelHiZBatch)
		...
		SimplePSO init_pso(Keys & key, std::function<void(SimplePSO&, Keys&)> f)
		{
			...
			SimplePSO mpso("VSMCopyLevelHiZBatch");
			if(f) f(mpso,key);

			mpso.root_signature = Layouts::DefaultLayout;

			mpso.compute.file_name = "shaders/vsm_copy_level_hiz_batch.hlsl";
