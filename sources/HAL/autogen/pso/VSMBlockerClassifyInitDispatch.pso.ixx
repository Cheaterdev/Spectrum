...
// ============================================================================
export module HAL:Autogen.PSO.VSMBlockerClassifyInitDispatch;
...
{
	struct VSMBlockerClassifyInitDispatch: public PSOBase
	{
		struct Keys {
			GEN_DEF_COMP(Keys);
		private:
		...
		GEN_COMPUTE_PSO(VSMBlockerClassifyInitDispatch)
		...
		SimplePSO init_pso(Keys & key, std::function<void(SimplePSO&, Keys&)> f)
		{
			...
			SimplePSO mpso("VSMBlockerClassifyInitDispatch");
			if(f) f(mpso,key);

			mpso.root_signature = Layouts::DefaultLayout;

			mpso.compute.file_name = "shaders/VSMBlockerClassifyInitDispatch.hlsl";
