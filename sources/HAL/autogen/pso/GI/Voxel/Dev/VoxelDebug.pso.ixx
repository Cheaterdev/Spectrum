...
// ============================================================================
export module HAL:Autogen.PSO.GI.Voxel.Dev.VoxelDebug;
			...
			namespace Dev
			{
				struct VoxelDebug: public PSOBase
				{
					...
					SimplePSO init_pso(Keys & key, std::function<void(SimplePSO&, Keys&)> f)
					{
						...
						mpso.vertex.file_name = "shaders/voxelgi/voxel_screen.hlsl";
						mpso.vertex.entry_point = "VS";
						mpso.vertex.flags = HAL::ShaderOptions::None;
			
						mpso.pixel.file_name = "shaders/voxelgi/voxel_screen_debug.hlsl";
