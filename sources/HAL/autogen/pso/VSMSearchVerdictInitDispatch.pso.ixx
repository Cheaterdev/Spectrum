...
// ============================================================================
export module HAL:Autogen.PSO.VSMSearchVerdictInitDispatch;
...
{
	struct VSMSearchVerdictInitDispatch: public PSOBase
	{
		struct Keys {
			GEN_DEF_COMP(Keys);
		private:
		...
		GEN_COMPUTE_PSO(VSMSearchVerdictInitDispatch)
		...
		SimplePSO init_pso(Keys & key, std::function<void(SimplePSO&, Keys&)> f)
		{
			...
			SimplePSO mpso("VSMSearchVerdictInitDispatch");
			if(f) f(mpso,key);

			mpso.root_signature = Layouts::DefaultLayout;

			mpso.compute.file_name = "shaders/VSMSearchVerdictInitDispatch.hlsl";
