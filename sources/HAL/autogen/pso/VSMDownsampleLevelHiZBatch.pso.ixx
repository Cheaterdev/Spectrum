...
// ============================================================================
export module HAL:Autogen.PSO.VSMDownsampleLevelHiZBatch;
...
{
	struct VSMDownsampleLevelHiZBatch: public PSOBase
	{
		struct Keys {
			GEN_DEF_COMP(Keys);
		private:
		...
		GEN_COMPUTE_PSO(VSMDownsampleLevelHiZBatch)
		...
		SimplePSO init_pso(Keys & key, std::function<void(SimplePSO&, Keys&)> f)
		{
			...
			SimplePSO mpso("VSMDownsampleLevelHiZBatch");
			if(f) f(mpso,key);

			mpso.root_signature = Layouts::DefaultLayout;

			mpso.compute.file_name = "shaders/vsm_downsample_level_hiz_batch.hlsl";
