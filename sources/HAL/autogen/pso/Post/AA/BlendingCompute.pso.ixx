...
// ============================================================================
export module HAL:Autogen.PSO.Post.AA.BlendingCompute;
...
export namespace PSOS
{
	namespace Post
	{
		namespace AA
		{
			struct BlendingCompute: public PSOBase
			{
				struct Keys {
					GEN_DEF_COMP(Keys);
				private:
				...
				GEN_COMPUTE_PSO(BlendingCompute)
				...
				SimplePSO init_pso(Keys & key, std::function<void(SimplePSO&, Keys&)> f)
				{
					...
					SimplePSO mpso("BlendingCompute");
					if(f) f(mpso,key);
