...
// ============================================================================
export module HAL:Autogen.PSO.Utility.CopyTexture;
	...
	namespace Utility
	{
		struct CopyTexture: public PSOBase
		{
			...
			SimplePSO init_pso(Keys & key, std::function<void(SimplePSO&, Keys&)> f)
			{
				...
				mpso.vertex.file_name = "shaders/postprocess/copy_texture.hlsl";
				mpso.vertex.entry_point = "VS";
				mpso.vertex.flags = HAL::ShaderOptions::None;
			
				mpso.pixel.file_name = "shaders/postprocess/copy_texture.hlsl";
