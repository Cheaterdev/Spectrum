...
// ============================================================================
export module HAL:Autogen.Tables.Denoise.NRD.REBLUR_PostBlurTS1Resources;
...
export namespace Table
{
	...
	namespace Denoise
	{
		namespace NRD
		{
			...
			{
				static constexpr SlotID ID = SlotID::REBLUR_PostBlurTS1Resources;
				...
				{
					compiler.compile(gIn_Tiles, "REBLUR_PostBlurTS1Resources::gIn_Tiles");
					compiler.compile(gIn_Normal_Roughness, "REBLUR_PostBlurTS1Resources::gIn_Normal_Roughness");
					compiler.compile(gIn_Data1, "REBLUR_PostBlurTS1Resources::gIn_Data1");
					compiler.compile(gIn_ViewZ, "REBLUR_PostBlurTS1Resources::gIn_ViewZ");
					compiler.compile(gIn_Diff, "REBLUR_PostBlurTS1Resources::gIn_Diff");
					compiler.compile(gOut_Normal_Roughness, "REBLUR_PostBlurTS1Resources::gOut_Normal_Roughness");
					compiler.compile(gOut_Diff, "REBLUR_PostBlurTS1Resources::gOut_Diff");
					compiler.compile(sharedConstants, "REBLUR_PostBlurTS1Resources::sharedConstants");
				}
				struct Compiled
				{
				...
				{
					return "Tables::REBLUR_PostBlurTS1Resources";
				}
				private:
				SERIALIZE()
				{
