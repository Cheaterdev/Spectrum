...
// ============================================================================
export module HAL:Autogen.Tables.Shadows.VSM.VSMLighting;
	...
	namespace Shadows
	{
		namespace VSM
		{
			struct VSMLighting
			{
				...
				HLSL::Texture2D<float> contact_shadow;
				...
				HLSL::Texture2D<float>& GetContact_shadow() { return contact_shadow; }
