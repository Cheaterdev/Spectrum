...
// ============================================================================
export module HAL:Autogen.Tables.Shadows.VSM.VSMConstants;
	...
	namespace Shadows
	{
		namespace VSM
		{
			struct VSMConstants
			{
				...
				::Shadows::VSM::VSMDebugView debug_view = ::Shadows::VSM::VSMDebugView::None;
				float4x4 light_view;
				...
				::Shadows::VSM::VSMDebugView& GetDebug_view() { return debug_view; }
