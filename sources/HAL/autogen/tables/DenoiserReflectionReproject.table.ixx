...
export namespace Table
{
	...
	struct DenoiserReflectionReproject
	{
		...
		{
			compiler.compile(g_depth_buffer, "DenoiserReflectionReproject::g_depth_buffer");
			compiler.compile(g_normal, "DenoiserReflectionReproject::g_normal");
			compiler.compile(g_depth_buffer_history, "DenoiserReflectionReproject::g_depth_buffer_history");
			compiler.compile(g_normal_history, "DenoiserReflectionReproject::g_normal_history");
			compiler.compile(g_radiance_history, "DenoiserReflectionReproject::g_radiance_history");
			compiler.compile(g_motion_vector, "DenoiserReflectionReproject::g_motion_vector");
			compiler.compile(g_average_radiance_history, "DenoiserReflectionReproject::g_average_radiance_history");
			compiler.compile(g_variance_history, "DenoiserReflectionReproject::g_variance_history");
			compiler.compile(g_sample_count_history, "DenoiserReflectionReproject::g_sample_count_history");
			compiler.compile(g_blue_noise_texture, "DenoiserReflectionReproject::g_blue_noise_texture");
			compiler.compile(g_denoiser_tile_list, "DenoiserReflectionReproject::g_denoiser_tile_list");
			compiler.compile(g_in_radiance, "DenoiserReflectionReproject::g_in_radiance");
			compiler.compile(g_out_reprojected_radiance, "DenoiserReflectionReproject::g_out_reprojected_radiance");
			compiler.compile(g_out_average_radiance, "DenoiserReflectionReproject::g_out_average_radiance");
			compiler.compile(g_out_variance, "DenoiserReflectionReproject::g_out_variance");
			compiler.compile(g_out_sample_count, "DenoiserReflectionReproject::g_out_sample_count");
		}
		struct Compiled
		{
