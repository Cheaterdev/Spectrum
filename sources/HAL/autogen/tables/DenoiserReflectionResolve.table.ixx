...
export namespace Table
{
	...
	struct DenoiserReflectionResolve
	{
		...
		{
			compiler.compile(g_normal, "DenoiserReflectionResolve::g_normal");
			compiler.compile(g_average_radiance, "DenoiserReflectionResolve::g_average_radiance");
			compiler.compile(g_in_reprojected_radiance, "DenoiserReflectionResolve::g_in_reprojected_radiance");
			compiler.compile(g_in_variance, "DenoiserReflectionResolve::g_in_variance");
			compiler.compile(g_in_sample_count, "DenoiserReflectionResolve::g_in_sample_count");
			compiler.compile(g_denoiser_tile_list, "DenoiserReflectionResolve::g_denoiser_tile_list");
			compiler.compile(g_in_radiance, "DenoiserReflectionResolve::g_in_radiance");
			compiler.compile(g_out_radiance, "DenoiserReflectionResolve::g_out_radiance");
			compiler.compile(g_out_variance, "DenoiserReflectionResolve::g_out_variance");
			compiler.compile(g_out_sample_count, "DenoiserReflectionResolve::g_out_sample_count");
		}
		struct Compiled
		{
