...
// ============================================================================
export module HAL:Autogen.Tables.Meshes.MaterialCommandData;
...
export namespace Table
{
	...
	namespace Meshes
	{
		struct MaterialCommandData
		{
			...
			uint material_cb;
			uint pipeline_id;
			::Meshes::TransparencyMode transparency_mode;
			uint opacity_texture_index;
			uint& GetMaterial_cb() { return material_cb; }
			uint& GetPipeline_id() { return pipeline_id; }
			::Meshes::TransparencyMode& GetTransparency_mode() { return transparency_mode; }
