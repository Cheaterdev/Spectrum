...
namespace HAL
{
	...
	const char* Shader<pixel_shader>::compile_code_dxil = "ps_6_8";
	const char* Shader<vertex_shader>::compile_code_dxil = "vs_6_8";
	const char* Shader<geometry_shader>::compile_code_dxil = "gs_6_8";
	const char* Shader<domain_shader>::compile_code_dxil = "ds_6_8";
	const char* Shader<hull_shader>::compile_code_dxil = "hs_6_8";
	const char* Shader<compute_shader>::compile_code_dxil = "cs_6_8";

    const char* Shader<mesh_shader>::compile_code_dxil = "ms_6_8";
    const char* Shader<amplification_shader>::compile_code_dxil = "as_6_8";

	
	const char* Shader<library_shader>::compile_code_dxil = "lib_6_8";
