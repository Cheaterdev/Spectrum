...
namespace GUI
{
    ...
    void Elements::scroll_bar::draw(Render::context& c)
    {
        ...
        /*
                if (drag->is_pressed())
                    renderer->draw(c, drag_skin.Pressed, drag->get_render_bounds());
                else if (drag->is_hovered())
                    renderer->draw(c, drag_skin.Hover, drag->get_render_bounds());
                else
                    renderer->draw(c, drag_skin.Normal, drag->get_render_bounds());
        */
