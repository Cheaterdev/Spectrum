...
namespace GUI
{
	...
	//		static thread_local int my_id;
			...
			//	draw_helper = true;
				...
				texture.texture = Graphics::Texture::get_resource(HAL::texure_header(to_path(L"textures/gui/background.png")));
		...
		//		get_label()->text = convert(name);
			...
			void TimeGraph::build()
			{
				...
				run_on_ui([this]() {
					...
					//	back->texture.texture = Graphics::Texture::get_resource(HAL::texure_header("textures/gui/debug_back.png"));
					//	back->texture.padding = { 16,16,16,16 };
						...
						line->texture.texture = Graphics::Texture::get_resource(HAL::texure_header(to_path(L"textures/gui/background.png")));
			...
			TimeGraph::TimeGraph()
			{
				...
				back->width_size = size_type::MATCH_CHILDREN;
			//	back->x_type = pos_x_type::LEFT;
				back->texture.texture = Graphics::Texture::get_resource(HAL::texure_header(to_path(L"textures/gui/debug_back.png")));
				back->texture.padding = { 16,16,16,16 };
				back->padding = { 4,4,4,4 };
				//back->size = {100,100 };
