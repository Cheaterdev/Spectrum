...
//using namespace HAL;
//
////void MipMapGenerator::generate(FrameContext& compute_context, HAL::Texture::ptr tex)
////{
////	generate(compute_context, tex->texture_2d());
////}
//
//void MipMapGenerator::generate_cube(FrameContext& compute_context, HAL::CubeView view)
//{
//	for (int i = 0; i < 6; i++)
//		generate(compute_context, view.get_face(i));
//}
//
//void MipMapGenerator::generate(FrameContext& compute_context, HAL::TextureView  view)
//{
//	//return;
...
//
//
//void MipMapGenerator::downsample_depth(FrameContext& compute_context, HAL::Texture::ptr tex, HAL::Texture::ptr& to)
//{
...
//}
//
//void MipMapGenerator::downsample_depth(FrameContext& compute_context, HAL::TextureView& tex, HAL::TextureView& to) {
//	compute_context.set_pipeline<PSOS::DownsampleDepth>();
//
//
//	Slots::DownsampleDepth data;
