...
// Shadows::VSM::ShadowSource::RTXReference is selected outside DLSS-RR (see
...
void PassDefault<Passes::Shadows::ShadowRTX>::render(
	Passes::Shadows::ShadowRTX::Context& data, FrameContext& context)
{
...

	{
		...
		RTX::get().render<Shadows::ShadowRTX>(compute, sceneinfo.scene->raytrace_scene, noisy_output.get_size());
	}
}
