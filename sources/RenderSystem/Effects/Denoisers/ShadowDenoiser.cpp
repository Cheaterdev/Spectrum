...
void ShadowDenoiser::generate(Graph& graph)
{
...

	{
		...
		graph.add_pass<ShadowDenoiser_PrepareData>(L"ShadowDenoiser_Prepare", [this, &graph, tileCount](ShadowDenoiser_PrepareData& data, TaskBuilder& builder) {
...

	{
		...
		graph.add_pass<ShadowDenoiser_TileClassificationData>(L"ShadowDenoiser_TileClassification", [this, &graph, tileCount, size](ShadowDenoiser_TileClassificationData& data, TaskBuilder& builder) {
	...
	}
	{
		...
		graph.add_pass<ShadowDenoiser_FilterData>(L"ShadowDenoiser_Filter", [this, &graph, tileCount, size](ShadowDenoiser_FilterData& data, TaskBuilder& builder) {
		//	builder.need(data.ShadowDenoiser_TileBuffer, ResourceFlags::ComputeRead);
