...
struct DefaultLayout: public FrameLayout
{
	struct Instance0
	{
		...
		static inline const std::vector<UINT> tables = {9, 11, 12};
	};
	struct Instance1
	{
		...
		static const unsigned int SRV_ID = 15;
		static const unsigned int UAV = 8;
		static const unsigned int UAV_ID = 16;
		static inline const std::vector<UINT> tables = {13, 15, 16};
	};
	struct Instance2
	{
		...
		static const unsigned int SRV_ID = 19;
		static const unsigned int UAV = 3;
		static const unsigned int UAV_ID = 20;
		static inline const std::vector<UINT> tables = {17, 19, 20};
	};
	struct Raytracing
	{
		static const unsigned int ID = 6;
		static const unsigned int CB = 2;
		static const unsigned int CB_ID = 21;
		static const unsigned int SRV = 2;
		static const unsigned int SRV_ID = 23;
		static inline const std::vector<UINT> tables = {21, 23};
	};
	struct MaterialData
	{
		...
		static inline const std::vector<UINT> tables = {24};
	};
