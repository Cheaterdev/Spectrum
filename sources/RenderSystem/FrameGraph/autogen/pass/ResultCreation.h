...
public:
	struct Context
	{
		...
		{
			builder.create_versioned(data.ResultTexture, cache.ResultTexture, { ivec3(builder.graph->get_context<Table::ViewportContext>().frame_size, 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 });
		}
