			...
			public:
				struct Context
				{
					...
					static void need_always(Context& data, FrameGraph::TaskBuilder& builder)
					{
						...
						if (builder.graph->get_context<Table::Shadows::VSM::VSMSelectors>().vsm_debug_view == ::Shadows::VSM::VSMDebugView::ContactShadow && builder.graph->get_context<Table::Shadows::VSM::VSMSelectors>().use_vsm_contact_shadow && builder.exists(data.VSM_ContactShadow))
