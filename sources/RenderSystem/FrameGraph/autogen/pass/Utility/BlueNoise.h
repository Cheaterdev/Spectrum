...
namespace Utility
{
	...
	public:
		struct Context
		{
			...
			{
				builder.create(data.BlueNoise, { ivec3(128, 128, 0), HAL::Format::R8G8_UNORM, 1, 1 }, FrameGraph::ResourceFlags::UnorderedAccess);
			}
			...
			{
				builder.create_versioned(data.BlueNoise, cache.BlueNoise, { ivec3(128, 128, 0), HAL::Format::R8G8_UNORM, 1, 1 });
			}
