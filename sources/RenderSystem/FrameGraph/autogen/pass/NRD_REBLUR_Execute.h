	...
	namespace NRD
	{
		...
		public:
			struct Context
			{
				...
				{
					builder.create(data.RTXIndirectDenoised, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 }, FrameGraph::ResourceFlags::UnorderedAccess);
					builder.create(data.RTXIndirectDenoisedPreview, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 }, FrameGraph::ResourceFlags::UnorderedAccess);
					builder.create(data.RTXReflectionDenoised, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 }, FrameGraph::ResourceFlags::UnorderedAccess);
				}
				...
				struct Cache
				{
					...
					FrameGraph::ChainIndex RTXIndirectDenoised = FrameGraph::ChainIndex::Unresolved;
					FrameGraph::ChainIndex RTXIndirectDenoisedPreview = FrameGraph::ChainIndex::Unresolved;
				...
				static void save_to_cache([[maybe_unused]] const Context& data, [[maybe_unused]] Cache& cache)
				{
					...
					cache.RTXIndirectDenoised = FrameGraph::TaskBuilder::cache_slot(data.RTXIndirectDenoised, ResourceID::RTXIndirectDenoised);
					cache.RTXIndirectDenoisedPreview = FrameGraph::TaskBuilder::cache_slot(data.RTXIndirectDenoisedPreview, ResourceID::RTXIndirectDenoisedPreview);
				...
				static void load_from_cache([[maybe_unused]] Context& data, [[maybe_unused]] const Cache& cache, [[maybe_unused]] const FrameGraph::TaskBuilder& builder)
				{
					...
					builder.load(data.NRD_DiffuseRadianceHitDist, ResourceID::NRD_DiffuseRadianceHitDist, cache.NRD_DiffuseRadianceHitDist);
					builder.load(data.NRD_SpecularRadianceHitDist, ResourceID::NRD_SpecularRadianceHitDist, cache.NRD_SpecularRadianceHitDist);
					builder.create_versioned(data.RTXIndirectDenoised, cache.RTXIndirectDenoised, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 });
					builder.create_versioned(data.RTXIndirectDenoisedPreview, cache.RTXIndirectDenoisedPreview, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 });
					builder.create_versioned(data.RTXReflectionDenoised, cache.RTXReflectionDenoised, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 });
				}
