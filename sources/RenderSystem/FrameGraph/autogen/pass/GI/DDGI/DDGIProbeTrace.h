		...
		public:
			struct Context
			{
				...
				static void create_always(Context& data, FrameGraph::TaskBuilder& builder)
				{
					if (data.pass_index == 0)
					{
					builder.create(data.DDGI_ProbeRayRadiance, { Constants::GI::DDGI::DDGI_ProbeCount * Constants::GI::DDGI::DDGI_CascadeCount * Constants::GI::DDGI::DDGI_ProbeRayCount }, FrameGraph::ResourceFlags::UnorderedAccess | FrameGraph::ResourceFlags::Static);
					}
				}
				...
				static void load_from_cache([[maybe_unused]] Context& data, [[maybe_unused]] const Cache& cache, [[maybe_unused]] const FrameGraph::TaskBuilder& builder)
				{
					...
					if (data.pass_index == 0)
					builder.create_versioned(data.DDGI_ProbeRayRadiance, cache.DDGI_ProbeRayRadiance, { Constants::GI::DDGI::DDGI_ProbeCount * Constants::GI::DDGI::DDGI_CascadeCount * Constants::GI::DDGI::DDGI_ProbeRayCount });
					else
