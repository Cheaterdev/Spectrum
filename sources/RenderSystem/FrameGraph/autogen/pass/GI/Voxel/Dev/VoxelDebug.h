		...
		namespace Dev
		{
			...
			public:
				struct Context
				{
					...
					{
						builder.create(data.VoxelDebug, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 }, FrameGraph::ResourceFlags::RenderTarget);
					}
					...
					struct Cache
					{
						...
						FrameGraph::ChainIndex VoxelDebug = FrameGraph::ChainIndex::Unresolved;
					...
					static void save_to_cache([[maybe_unused]] const Context& data, [[maybe_unused]] Cache& cache)
					{
						...
						cache.VoxelDebug = FrameGraph::TaskBuilder::cache_slot(data.VoxelDebug, ResourceID::VoxelDebug);
					...
					static void load_from_cache([[maybe_unused]] Context& data, [[maybe_unused]] const Cache& cache, [[maybe_unused]] const FrameGraph::TaskBuilder& builder)
					{
						...
						builder.create_versioned(data.VoxelDebug, cache.VoxelDebug, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 });
