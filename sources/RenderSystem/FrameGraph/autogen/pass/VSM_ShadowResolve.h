		...
		public:
			struct Context
			{
				...
				static void need_always(Context& data, FrameGraph::TaskBuilder& builder)
				{
					...
					if (builder.graph->get_context<Table::Shadows::VSM::VSMSelectors>().use_vsm_contact_shadow && builder.exists(data.VSM_ContactShadow))
				...
				{
					builder.create(data.VSM_PCSS_ShadowNoise, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 0), HAL::Format::R16_FLOAT, 1, 1 }, FrameGraph::ResourceFlags::UnorderedAccess);
				}
				...
				static void load_from_cache([[maybe_unused]] Context& data, [[maybe_unused]] const Cache& cache, [[maybe_unused]] const FrameGraph::TaskBuilder& builder)
				{
					...
					builder.create_versioned(data.VSM_PCSS_ShadowNoise, cache.VSM_PCSS_ShadowNoise, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 0), HAL::Format::R16_FLOAT, 1, 1 });
				}
