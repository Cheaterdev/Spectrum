...
namespace Shadows
{
	...
	public:
		struct Context
		{
			...
			{
				builder.create(data.ShadowMask, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 }, FrameGraph::ResourceFlags::UnorderedAccess);
				builder.create(data.WorkGraphBuffer, { Constants::Dev::WG_TileSection }, FrameGraph::ResourceFlags::UnorderedAccess);
			}
			...
			static void load_from_cache([[maybe_unused]] Context& data, [[maybe_unused]] const Cache& cache, [[maybe_unused]] const FrameGraph::TaskBuilder& builder)
			{
				...
				builder.create_versioned(data.ShadowMask, cache.ShadowMask, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 });
				builder.create_versioned(data.WorkGraphBuffer, cache.WorkGraphBuffer, { Constants::Dev::WG_TileSection });
			}
