	...
	namespace VSM
	{
		...
		public:
			struct Context
			{
				...
				{
					builder.create(data.VSM_LitTiles, { 2 * Math::Area(Math::DivideByMultiple(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 16)), true }, FrameGraph::ResourceFlags::UnorderedAccess);
					builder.create(data.VSM_DarkTiles, { 2 * Math::Area(Math::DivideByMultiple(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 16)), true }, FrameGraph::ResourceFlags::UnorderedAccess);
					builder.create(data.VSM_SearchTiles, { 2 * Math::Area(Math::DivideByMultiple(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 16)), true }, FrameGraph::ResourceFlags::UnorderedAccess);
				}
				...
				static void load_from_cache([[maybe_unused]] Context& data, [[maybe_unused]] const Cache& cache, [[maybe_unused]] const FrameGraph::TaskBuilder& builder)
				{
					...
					builder.create_versioned(data.VSM_LitTiles, cache.VSM_LitTiles, { 2 * Math::Area(Math::DivideByMultiple(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 16)), true });
					builder.create_versioned(data.VSM_DarkTiles, cache.VSM_DarkTiles, { 2 * Math::Area(Math::DivideByMultiple(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 16)), true });
					builder.create_versioned(data.VSM_SearchTiles, cache.VSM_SearchTiles, { 2 * Math::Area(Math::DivideByMultiple(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 16)), true });
				}
