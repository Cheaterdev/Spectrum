	...
	namespace PSSM
	{
		...
		public:
			struct Context
			{
				...
				{
					builder.create(data.LightMask, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 0), HAL::Format::R8_UNORM, 1, 1 }, FrameGraph::ResourceFlags::RenderTarget);
				}
				...
				struct Cache
				{
					...
					FrameGraph::ChainIndex LightMask = FrameGraph::ChainIndex::Unresolved;
				};
				...
				static void save_to_cache([[maybe_unused]] const Context& data, [[maybe_unused]] Cache& cache)
				{
					...
					cache.LightMask = FrameGraph::TaskBuilder::cache_slot(data.LightMask, ResourceID::LightMask);
				}
				...
				static void load_from_cache([[maybe_unused]] Context& data, [[maybe_unused]] const Cache& cache, [[maybe_unused]] const FrameGraph::TaskBuilder& builder)
				{
					...
					builder.create_versioned(data.LightMask, cache.LightMask, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 0), HAL::Format::R8_UNORM, 1, 1 });
				}
