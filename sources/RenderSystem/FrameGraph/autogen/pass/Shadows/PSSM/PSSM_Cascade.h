	...
	namespace PSSM
	{
		...
		public:
			struct Context
			{
				...
				Handlers::StructuredBuffer<Table::Frame::Camera> PSSM_Cameras = ResourceID::PSSM_Cameras;
				...
				static void create_always(Context& data, FrameGraph::TaskBuilder& builder)
				{
					if (data.pass_index == 0)
					{
					builder.create(data.PSSM_Depths, { ivec3(1024, 1024, 0), HAL::Format::R32_TYPELESS, Constants::Shadows::PSSM::PSSM_RendersSize, 1 }, FrameGraph::ResourceFlags::DepthStencil);
					}
					if (data.pass_index == 0)
					{
					builder.create(data.PSSM_Cameras, { Constants::Shadows::PSSM::PSSM_RendersSize }, FrameGraph::ResourceFlags::CopyDest);
					}
				}
				...
				{
					if (data.pass_index == 0)
					builder.create_versioned(data.PSSM_Depths, cache.PSSM_Depths, { ivec3(1024, 1024, 0), HAL::Format::R32_TYPELESS, Constants::Shadows::PSSM::PSSM_RendersSize, 1 });
					else
						builder.load(data.PSSM_Depths, ResourceID::PSSM_Depths, cache.PSSM_Depths);
					if (data.pass_index == 0)
					builder.create_versioned(data.PSSM_Cameras, cache.PSSM_Cameras, { Constants::Shadows::PSSM::PSSM_RendersSize });
					else
