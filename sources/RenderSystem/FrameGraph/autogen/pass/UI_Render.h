	...
	public:
		struct Context
		{
			...
			struct Cache
			{
				...
				FrameGraph::ChainIndex UI_PreDraw_Sync = FrameGraph::ChainIndex::Unresolved;
			...
			static void save_to_cache([[maybe_unused]] const Context& data, [[maybe_unused]] Cache& cache)
			{
				...
				cache.UI_PreDraw_Sync = FrameGraph::TaskBuilder::cache_slot(data.UI_PreDraw_Sync, ResourceID::UI_PreDraw_Sync);
			...
			static void load_from_cache([[maybe_unused]] Context& data, [[maybe_unused]] const Cache& cache, [[maybe_unused]] const FrameGraph::TaskBuilder& builder)
			{
				...
				builder.load(data.UI_PreDraw_Sync, ResourceID::UI_PreDraw_Sync, cache.UI_PreDraw_Sync);
