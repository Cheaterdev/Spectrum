...
public:
	struct Context
	{
		...
		static void create_always(Context& data, FrameGraph::TaskBuilder& builder)
		{
			...
			builder.create(data.GBuffer_HalfDepth, { ivec3(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 2), 0), HAL::Format::R32_FLOAT, 1, 1 }, FrameGraph::ResourceFlags::UnorderedAccess);
			builder.create(data.GBuffer_HalfNormals, { ivec3(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 2), 0), HAL::Format::R8G8B8A8_UNORM, 1, 1 }, FrameGraph::ResourceFlags::UnorderedAccess);
			builder.create(data.TileClassifyHi, { Math::Area(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 8)), true }, FrameGraph::ResourceFlags::UnorderedAccess);
			builder.create(data.TileClassifyLow, { Math::Area(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 8)), true }, FrameGraph::ResourceFlags::UnorderedAccess);
			...
			builder.create(data.TileClassifyTiles, { ivec3(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 8), 0), HAL::Format::R8_UINT, 1, 1 }, FrameGraph::ResourceFlags::UnorderedAccess);
			builder.create(data.TileRoughnessHi, { Math::Area(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 8)), true }, FrameGraph::ResourceFlags::UnorderedAccess);
			builder.create(data.TileRoughnessLow, { Math::Area(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 8)), true }, FrameGraph::ResourceFlags::UnorderedAccess);
			builder.create(data.TileRoughnessTiles, { ivec3(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 8), 0), HAL::Format::R8_UINT, 1, 1 }, FrameGraph::ResourceFlags::UnorderedAccess);
		}
		...
		static void load_from_cache([[maybe_unused]] Context& data, [[maybe_unused]] const Cache& cache, [[maybe_unused]] const FrameGraph::TaskBuilder& builder)
		{
			...
			builder.create_versioned(data.GBuffer_TempColor, cache.GBuffer_TempColor, { ivec3(builder.graph->get_context<Table::ViewportContext>().frame_size, 0), HAL::Format::R8G8_UNORM, 1, 1 });
			builder.create_versioned(data.GBuffer_HalfDepth, cache.GBuffer_HalfDepth, { ivec3(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 2), 0), HAL::Format::R32_FLOAT, 1, 1 });
			builder.create_versioned(data.GBuffer_HalfNormals, cache.GBuffer_HalfNormals, { ivec3(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 2), 0), HAL::Format::R8G8B8A8_UNORM, 1, 1 });
			builder.create_versioned(data.TileClassifyHi, cache.TileClassifyHi, { Math::Area(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 8)), true });
			builder.create_versioned(data.TileClassifyLow, cache.TileClassifyLow, { Math::Area(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 8)), true });
			builder.create_versioned(data.TileClassifyMask, cache.TileClassifyMask, { ivec3(builder.graph->get_context<Table::ViewportContext>().frame_size, 0), HAL::Format::R8_UINT, 1, 1 });
			builder.create_versioned(data.TileClassifyTiles, cache.TileClassifyTiles, { ivec3(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 8), 0), HAL::Format::R8_UINT, 1, 1 });
			builder.create_versioned(data.TileRoughnessHi, cache.TileRoughnessHi, { Math::Area(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 8)), true });
			builder.create_versioned(data.TileRoughnessLow, cache.TileRoughnessLow, { Math::Area(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 8)), true });
			builder.create_versioned(data.TileRoughnessTiles, cache.TileRoughnessTiles, { ivec3(Math::DivideByMultiple(builder.graph->get_context<Table::ViewportContext>().frame_size, 8), 0), HAL::Format::R8_UINT, 1, 1 });
		}
