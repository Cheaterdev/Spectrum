...
namespace GI
{
	...
	public:
		struct Context
		{
			...
			{
				builder.create(data.RTXIndirectNoiseHalf, { ivec3(Math::DivideByMultiple(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 2), 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 }, FrameGraph::ResourceFlags::UnorderedAccess);
			}
			...
			static void load_from_cache([[maybe_unused]] Context& data, [[maybe_unused]] const Cache& cache, [[maybe_unused]] const FrameGraph::TaskBuilder& builder)
			{
				...
				builder.create_versioned(data.RTXIndirectNoiseHalf, cache.RTXIndirectNoiseHalf, { ivec3(Math::DivideByMultiple(builder.graph->get_context<Table::Frame::ViewportContext>().frame_size, 2), 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 });
			}
