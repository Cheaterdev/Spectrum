...
public:
	struct Context
	{
		...
		struct Cache
		{
			FrameGraph::ChainIndex depth_tex = FrameGraph::ChainIndex::Unresolved;
			FrameGraph::ChainIndex id_buffer = FrameGraph::ChainIndex::Unresolved;
		...
		{
			cache.depth_tex = FrameGraph::TaskBuilder::cache_slot(data.depth_tex, ResourceID::depth_tex);
			cache.id_buffer = FrameGraph::TaskBuilder::cache_slot(data.id_buffer, ResourceID::id_buffer);
		...
		{
			builder.create_versioned(data.depth_tex, cache.depth_tex, { ivec3(1, 1, 0), HAL::Format::R32_TYPELESS, 1, 1 });
			builder.create_versioned(data.id_buffer, cache.id_buffer, { 1 });
