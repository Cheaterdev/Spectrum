...
namespace Post
{
	...
	class BloomBuildPost : public PassNodeBase
	{
	public:
		struct Context
		{
			...
			Handlers::Texture FlareStreakA = ResourceID::FlareStreakA;


			Handlers::Texture FlareStreakB = ResourceID::FlareStreakB;
			...
			static void create_always(Context& data, FrameGraph::TaskBuilder& builder)
			{
				...
				builder.create(data.FlareStreaks, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().upscale_size / 4, 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 }, FrameGraph::ResourceFlags::UnorderedAccess);
			}
			...
			static void load_from_cache([[maybe_unused]] Context& data, [[maybe_unused]] const Cache& cache, [[maybe_unused]] const FrameGraph::TaskBuilder& builder)
			{
				...
				builder.create_versioned(data.FlareStreaks, cache.FlareStreaks, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().upscale_size / 4, 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 });
			}
		...
		static constexpr LiteralWStr Name{L"BloomBuildPost"};

		static constexpr PassID ID = PassID::BloomBuildPost;
