		...
		public:
			struct Context
			{
				...
				static void create_always(Context& data, FrameGraph::TaskBuilder& builder)
				{
					...
					builder.create(data.FSRTemp, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().upscale_size, 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 }, FrameGraph::ResourceFlags::UnorderedAccess);
				}
				...
				struct Cache
				{
					...
					FrameGraph::ChainIndex FSRTemp = FrameGraph::ChainIndex::Unresolved;
				};
				...
				static void save_to_cache([[maybe_unused]] const Context& data, [[maybe_unused]] Cache& cache)
				{
					...
					cache.FSRTemp = FrameGraph::TaskBuilder::cache_slot(data.FSRTemp, ResourceID::FSRTemp);
				}
				...
				static void load_from_cache([[maybe_unused]] Context& data, [[maybe_unused]] const Cache& cache, [[maybe_unused]] const FrameGraph::TaskBuilder& builder)
				{
					...
					builder.create_versioned(data.FSRTemp, cache.FSRTemp, { ivec3(builder.graph->get_context<Table::Frame::ViewportContext>().upscale_size, 0), HAL::Format::R16G16B16A16_FLOAT, 1, 1 });
				}
