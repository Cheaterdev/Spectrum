...
namespace D3D
{
    ...
    D3D_SHADER_DESC::D3D_SHADER_DESC(const D3D11_SHADER_DESC& desc)
    {
        Version = desc.Version;
    ...
    D3D_SHADER_VARIABLE_DESC::D3D_SHADER_VARIABLE_DESC(const D3D11_SHADER_VARIABLE_DESC& desc)
    {
        Name = desc.Name;
    ...
    D3D_SHADER_INPUT_BIND_DESC::D3D_SHADER_INPUT_BIND_DESC(const D3D11_SHADER_INPUT_BIND_DESC& desc)
    {
        Name = desc.Name;
        Type = desc.Type;
    ...
    D3D_SHADER_BUFFER_DESC::D3D_SHADER_BUFFER_DESC(const D3D11_SHADER_BUFFER_DESC& desc)
    {
        Name = desc.Name;
        Type = desc.Type;
    ...
    D3D_SIGNATURE_PARAMETER_DESC::D3D_SIGNATURE_PARAMETER_DESC(const D3D11_SIGNATURE_PARAMETER_DESC& desc)
    {
    ...
    reflection::reflection(CComPtr<ID3D12ShaderReflection> pReflector) {
