...
namespace Denoise
{
	namespace NRD
	{
		struct REBLUR_TemporalStabilizationResources
		{
			...
			Texture2D<float> GetGHistory_DiffLumaStabilized() { return ResourceDescriptorHeap[gHistory_DiffLumaStabilized]; }
			...
			RWTexture2D<float> GetGOut_DiffLumaStabilized() { return ResourceDescriptorHeap[gOut_DiffLumaStabilized]; }
		};
	}
}
using Denoise::NRD::REBLUR_TemporalStabilizationResources;