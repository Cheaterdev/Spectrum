...
struct MipMapping
{
	...
	RWTexture2D<float4> GetOutMip_0() { return ResourceDescriptorHeap[OutMip_0]; }
	RWTexture2D<float4> GetOutMip_1() { return ResourceDescriptorHeap[OutMip_1]; }
	RWTexture2D<float4> GetOutMip_2() { return ResourceDescriptorHeap[OutMip_2]; }
	RWTexture2D<float4> GetOutMip_3() { return ResourceDescriptorHeap[OutMip_3]; }
