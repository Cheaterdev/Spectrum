...
// comment for the shim pattern). TEMPORAL_STABILIZATION=0: PostBlur also
// emits gOut_InternalData/gOut_DiffCopy since the TemporalStabilization pass
// is disabled and won't produce them itself.
#define NRD_INTERNAL
#define NRD_SIGNAL DIFF
#define NRD_MODE RADIANCE

#include "../autogen/REBLUR_PostBlurTS0Resources.h"

#define NRD_CONSTANTS_START( resourceName ) \
	static const ConstantBuffer<REBLUR_PostBlurTS0Resources> _nrd_res = GetREBLUR_PostBlurTS0Resources(); \
...
#define NRD_OUTPUTS_END \
	...
	static const RWTexture2D<float4> gOut_DiffCopy = _nrd_res.GetGOut_DiffCopy();
