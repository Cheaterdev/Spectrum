...
#include "../autogen/REBLUR_TemporalStabilizationResources.h"

#define NRD_CONSTANTS_START( resourceName ) \
	static const ConstantBuffer<REBLUR_TemporalStabilizationResources> _nrd_res = GetREBLUR_TemporalStabilizationResources(); \
...
#define NRD_INPUTS_END \
	...
	static const Texture2D<float> gHistory_DiffLumaStabilized = _nrd_res.GetGHistory_DiffLumaStabilized();

#define NRD_OUTPUTS_START
#define NRD_OUTPUT( resourceType, dataType, resourceName, regName, bindingIndex )
#define NRD_OUTPUTS_END \
	static const RWTexture2D<float4> gInOut_Mv = _nrd_res.GetGInOut_Mv(); \
