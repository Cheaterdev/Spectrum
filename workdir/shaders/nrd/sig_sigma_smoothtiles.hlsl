...
// comment for the shim pattern). Constants route through the real
// SIGMASharedConstants CBV (see HAL.NRD.cpp's fill_sigma_shared_constants).
#include "../autogen/SIGMA_SmoothTilesResources.h"

#define NRD_CONSTANTS_START( resourceName ) \
	static const ConstantBuffer<SIGMA_SmoothTilesResources> _nrd_res = GetSIGMA_SmoothTilesResources(); \
