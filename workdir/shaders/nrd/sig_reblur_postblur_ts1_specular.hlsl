// REBLUR_SPECULAR sibling of sig_reblur_postblur_ts1.hlsl (see
// [[project-nrd-integration]]). TEMPORAL_STABILIZATION=1: the
...
#include "../autogen/REBLUR_PostBlurTS1SpecularResources.h"

#define NRD_CONSTANTS_START( resourceName ) \
	static const ConstantBuffer<REBLUR_PostBlurTS1SpecularResources> _nrd_res = GetREBLUR_PostBlurTS1SpecularResources(); \
