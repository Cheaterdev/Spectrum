...
#include "../autogen/SIGMA_TemporalStabilizationResources.h"
...
#define NRD_INPUTS_START   static const ConstantBuffer<SIGMA_TemporalStabilizationResources> _nrd_res = GetSIGMA_TemporalStabilizationResources();
...
#define NRD_INPUTS_END \
	...
	static const Texture2D<float> gIn_History = _nrd_res.GetGIn_History(); \
