...
#include "../autogen/REBLUR_HistoryFixResources.h"

#define NRD_CONSTANTS_START( resourceName ) \
	static const ConstantBuffer<REBLUR_HistoryFixResources> _nrd_res = GetREBLUR_HistoryFixResources(); \
...
#define NRD_INPUTS_END \
	...
	static const Texture2D<float> gIn_DiffFast = _nrd_res.GetGIn_DiffFast();
