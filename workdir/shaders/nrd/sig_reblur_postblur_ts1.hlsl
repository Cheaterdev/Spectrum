...
// comment for the shim pattern). TEMPORAL_STABILIZATION=1: the
// TemporalStabilization pass runs afterward and owns gOut_InternalData
// itself, so PostBlur skips producing it here.
#define NRD_INTERNAL
#define NRD_SIGNAL DIFF
#define NRD_MODE RADIANCE

#include "../autogen/REBLUR_PostBlurTS1Resources.h"

#define NRD_CONSTANTS_START( resourceName ) \
	static const ConstantBuffer<REBLUR_PostBlurTS1Resources> _nrd_res = GetREBLUR_PostBlurTS1Resources(); \
