...
#include "../autogen/REBLUR_PrePassSpecularResources.h"

#define NRD_CONSTANTS_START( resourceName ) \
	static const ConstantBuffer<REBLUR_PrePassSpecularResources> _nrd_res = GetREBLUR_PrePassSpecularResources(); \
