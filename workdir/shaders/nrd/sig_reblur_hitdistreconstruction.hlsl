...
#include "../autogen/REBLUR_HitDistReconstructionResources.h"

#define NRD_CONSTANTS_START( resourceName ) \
	static const ConstantBuffer<REBLUR_HitDistReconstructionResources> _nrd_res = GetREBLUR_HitDistReconstructionResources(); \
...
// MODE_5X5=0 permutation. See sig_reblur_hitdistreconstruction_5x5.hlsl for
// the MODE_5X5=1 sibling -- same resource layout (the #if only affects
// NRD_BORDER, not resources.hlsli's declarations), but NRD reports these as
