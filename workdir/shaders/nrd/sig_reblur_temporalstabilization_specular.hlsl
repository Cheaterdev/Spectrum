...
#include "../autogen/REBLUR_TemporalStabilizationSpecularResources.h"

#define NRD_CONSTANTS_START( resourceName ) \
	static const ConstantBuffer<REBLUR_TemporalStabilizationSpecularResources> _nrd_res = GetREBLUR_TemporalStabilizationSpecularResources(); \
...
#define NRD_INPUTS_END \
	...
	static const Texture2D<float> gHistory_SpecLumaStabilized = _nrd_res.GetGHistory_SpecLumaStabilized();
