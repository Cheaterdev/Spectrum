...
return result/16;// light_raw_z > pos_l.z;
}
...
info.roughness = gbuffer[1].SampleLevel(pixel_sampler, i.tc, 0).w + 0.1;// gbuffer[2][tc.xy].w;
...
float3 light_dir = -light_cameras[0].direction;
